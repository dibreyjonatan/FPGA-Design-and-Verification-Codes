...
begin
    ...
    stim : process
		...
		--	wait for 935 ms;  -- pour que 65+935 = 1s par chaque mesure   
        end procedure;
    begin
        rst <= '0';
        ...
        for i in ANGLES'range loop
            ...
            if data_valid /= '1' then
                ...
                report "OK : angle " & integer'image(ANGLES(i)) & " correctement mesurer";
            end if;
        end loop;
