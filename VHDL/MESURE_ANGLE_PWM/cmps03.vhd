...
entity cmps03 is
    ...
    port (
        ...
        continu       : in  std_logic;      -- non utilisé dans cette FSM
        start_stop    : in  std_logic;      -- non utilisé dans cette FSM
...
begin
    ...
    ------------------------------------------------------------------
    -- PROCESS 1/3 (obligatoire) : registre d'etat
    ------------------------------------------------------------------
    ...
    ------------------------------------------------------------------
    -- PROCESS 2/3 (obligatoire) : logique d'etat suivant (combinatoire)
    ------------------------------------------------------------------
    ...
    ------------------------------------------------------------------
    -- PROCESS 3/3 (obligatoire) : sortie de Mealy (combinatoire,
    -- depend de l'etat ET d'une condition d'entree)
    ------------------------------------------------------------------
    ...
    ------------------------------------------------------------------
    -- Processus additionnels : synchroniseur + chemin de donnees
    ------------------------------------------------------------------
    ...
    begin
        if rst = '0' then
            ...
            if ms_cmpt = MS_CYC - 1 then
                ms_cmpt <= 0; fin_tim <= '1';
            else
                ms_cmpt <= ms_cmpt + 1; fin_tim <= '0';
            end if;
